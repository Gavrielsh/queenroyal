...
/**
 * Inbound B2B webhook from an external Game Aggregator (e.g. Pragmatic Play). This is
 * the provider's translated payload — NOT a player request. Money is decimal strings;
