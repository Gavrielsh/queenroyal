...
/**
 * Server-side KYC gating for money-mutating paths. The decision is made from the player's
 * CURRENT status in our database — never from a (potentially stale) claim baked into a
 * long-lived JWT.
 *
